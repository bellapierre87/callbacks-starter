...
let mySimpleReduce = function(arr, cb) {
    let acc = arr[0];  //set accumulator "acc" to be  first index of the arry, "arr[0]"

    //fo reach element, pass it with the accumulator into the cb function
    //set accumulator to be the result
